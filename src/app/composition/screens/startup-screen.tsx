...
export function StartupScreen() {
  ...
  return (
    <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-12 px-5 py-10 text-foreground selection:bg-foreground selection:text-background sm:px-8 sm:py-14 lg:px-12 lg:py-16">
      <div className="mt-18 space-y-5 pl-4">
        <h1 className="text-3xl font-medium tracking-tight text-foreground">Codex Web</h1>
        <p className="max-w-2xl text-lg leading-6 text-muted-foreground">
          {isZh
            ? '本地 Codex Web 客户端，提供隔离的 Owner 与 Guest runtime 部署。'
            : 'A local Codex Web client with isolated Owner and Guest runtime deployments.'}
        </p>
      ...
      <figure className="overflow-hidden rounded-3xl bg-white">
        <img
          ...
          alt="Codex Web architecture showing the browser, Fastify bridge, durable services, and isolated Owner and Guest runtimes."
